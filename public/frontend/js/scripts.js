(function($) {
	$(document).ready(function() {
		...
		// HAMBURGER AUDIO
            ...
            document.getElementById('zs1').style.color = "#ffffff";
            document.getElementById('zs2').style.color = "#ffffff";
            var elements=document.getElementsByClassName('spandyali');
            for(const element of elements ){
                element.classList.add("spanmenu");
            }
		...
		$('.hamburger').on('click', function(e) {
			if ($(".navigation-menu").hasClass("active")) {
                document.getElementById('zs1').style.color = "#1D1E22";
                document.getElementById('zs2').style.color = "#ffffff";
                var elements=document.getElementsByClassName('spandyali');
                for(const element of elements ){
                    element.classList.remove("spanmenu");
                }
